<template>
    <v-row justify="center">
        <v-card class="social-card" shaped elevation="24">
            <v-card-text>
                <div class="social-card-text d-flex justify-space-between align-center">
                    <span>Join other industry-leading organizations pushing boundaries and solving problems in
                        Figma</span>
                    <v-img width="64"
